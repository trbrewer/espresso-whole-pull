...
class StageA(unittest.TestCase):
 ...
 def test_allowed_paths_and_immutable_runtime_lock(self):
  ...
  allowed=('AGENTS.md','CONTRIBUTING.md','docs/governance/','docs/validation/sci_md_004/','docs/validation/sci_md_005/','docs/validation/sci_md_006/','validation/sci_md_004_stage_e0/','validation/sci_md_004_stage_e1/','validation/sci_md_004_stage_e1_hydraulic_reconciliation/','validation/sci_md_005/','validation/sci_md_006/','validation/contracts/SCI_MD_004_STAGE_A_MULTISPECIES.json','validation/contracts/SCI_MD_004_STAGE_C_IMPLEMENTATION_AND_VERIFICATION.json','validation/contracts/SCI_MD_004_STAGE_C_R1_VERIFICATION_COMPLETION.json','validation/contracts/SCI_MD_004_STAGE_C_R2_SEPARATED_SPACE_TIME_VERIFICATION.json','tools/sci_md_004_contract/','tools/sci_md_004_stage_c/','tools/sci_md_004_stage_e0_freeze.py','tools/sci_md_004_stage_e1/','tools/sci_md_004_stage_e1_hydraulic.py','tools/sci_md_004_stage_e1_predict.py','tools/sci_md_004_stage_e1_score.py','tools/sci_md_005/','tools/sci_md_006/','tools/inventory_scaled_composition/','tests/test_sci_md_004_stage_a.py','tests/test_sci_md_004_stage_c.py','tests/test_sci_md_004_stage_e0_freeze.py','tests/test_sci_md_004_stage_e1.py','tests/test_sci_md_004_stage_e1_hydraulic.py','tests/test_sci_md_005.py','tests/test_sci_md_006.py','tests/test_current_authority_consistency.py','scripts/prepare_case.py','solver/espressoWholePullFoam/espressoWholePullFoam.C','docs/PROJECT_STATE.md','docs/CLAIM_CEILING.md','docs/ARCHITECTURE.md','docs/MODEL_SPECIFICATION.md','SOURCE_PACKAGE_MANIFEST.json','PACKAGE_QA_STATUS.json','docs/QA_STATUS.md')
