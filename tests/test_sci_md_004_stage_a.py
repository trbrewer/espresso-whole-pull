...
class StageA(unittest.TestCase):
 ...
 def test_allowed_paths_and_immutable_runtime_lock(self):
  ...
  allowed=('docs/validation/sci_md_004/','validation/contracts/SCI_MD_004_STAGE_A_MULTISPECIES.json','validation/contracts/SCI_MD_004_STAGE_C_IMPLEMENTATION_AND_VERIFICATION.json','validation/contracts/SCI_MD_004_STAGE_C_R1_VERIFICATION_COMPLETION.json','tools/sci_md_004_contract/','tools/sci_md_004_stage_c/','tests/test_sci_md_004_stage_a.py','tests/test_sci_md_004_stage_c.py','tests/test_current_authority_consistency.py','scripts/prepare_case.py','solver/espressoWholePullFoam/espressoWholePullFoam.C','docs/PROJECT_STATE.md','docs/ARCHITECTURE.md','docs/MODEL_SPECIFICATION.md','SOURCE_PACKAGE_MANIFEST.json','PACKAGE_QA_STATUS.json','docs/QA_STATUS.md')
