...
class TestAvailableDataFirst(unittest.TestCase):
 ...
 def test_authority_and_exemplar(self):
  a=json.loads((ROOT/"provenance/AVAILABLE_DATA_AUTHORITY.json").read_text()); self.assertEqual(a["puckworks_commit"],"0496d76e59ce10d287aedb638ed3f8a4b7cc5111"); self.assertNotIn("/home/",json.dumps(a))
