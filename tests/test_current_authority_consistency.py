...
CURRENT_MARKERS = {
    "README.md": (
        "SCI-ED-003 is complete",
        "`CLOSURE_CONTRACT_DEFINED_EXECUTION_NOT_AUTHORIZED`",
        "`OWNER_DECISION_PENDING`",
        "neither Stage F nor Stage D is authorized",
        "no solver, surrogate, or execution task is active",
