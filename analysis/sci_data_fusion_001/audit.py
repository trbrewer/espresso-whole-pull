...
from .authority import AuthorityError,SUPERSEDED_FREEZE,git,load_json,sha256,verify_freeze_manifest
...
def validate_audit(root:Path,audit_path:Path,manifest_path:Path)->dict:
    ...
    if record["reviewed_head"]==SUPERSEDED_FREEZE:raise AuthorityError("audit refers to superseded original freeze")
