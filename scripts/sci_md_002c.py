...
def pilot_run(bundle_arg):
    ...
    m={"schema_version":"ewp.sci_md_002c.pilot_manifest.v1","bundle_uuid":bid,"record_count":len(rows),"records":rows,"ordered_record_aggregate_sha256":hash_obj(rows)}; durable_write(b/"manifest.json",m)
