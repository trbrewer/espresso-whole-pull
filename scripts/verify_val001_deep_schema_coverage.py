...
def verify(root:Path):
 ...
 return {"records":len(seen),"families":len(observed_schema['anyOf'])+2,"deep_json_records":validated,"sidecar_primary":sidecars,"unregistered":0,"multiply_registered":0,"real_data_comparisons":0}
def main():
