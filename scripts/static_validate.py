...
def main() -> None:
    ...
    for path in python_sources:
        ...
        scientific_test = path.relative_to(root).as_posix() in ("tests/test_sci_md_rheology_005.py", "tests/test_sci_md_rheology_006.py", "tests/test_sci_md_rheology_007.py", "tests/test_sci_md_rheology_008.py")
