...
def main() -> None:
    ...
    result = {"schema_version": "espresso.val001.comparison_result.v2", "task": "VAL-001", "classification": "POST_OBSERVATION_REPRODUCTION", "input": {"path": spec["input"]["path"], "sha256": spec["input"]["sha256"], "selected_row_canonical_sha256": spec["input"]["selected_row_canonical_sha256"], "invocation_id": invocation_id, "authority_record_sha256": sha256(args.authority), "adapter_sha256": sha256(adapter_path), "runner_sha256": sha256(Path(__file__)), "second_freeze": authority.get("second_freeze"), "activation_record_sha256": sha256(args.activation), "reused_openfoam_artifacts": activation.get("reused_openfoam_artifacts", []), "evidence_level": adapter["evidence"]["level"], "rights_status": adapter["rights"]["access_status"]}, "execution_counts": {"second_correction_real_data_comparison_invocations": 1, "second_correction_governed_result_producing_invocations": 1, "second_correction_test_or_ci_real_data_invocations": 0, "first_corrected_cycle_real_data_invocations": 1, "minimum_known_precorrection_real_data_computations": 3, "minimum_known_total_real_data_computations": 5, "new_openfoam_builds": 0, "new_openfoam_case_executions": 0, "fit_or_retune_count": 0, "protected_access_count": 0, "holdout_score_count": 0}, "comparisons": comparisons, "interpretation": {"rules_fired": fired, "decision": decision, "variant_discrimination": "NOT_ESTABLISHED", "physical_equivalence": "NOT_ESTABLISHED", "model_correctness": "NOT_ESTABLISHED", "mechanism_identification": "NOT_ESTABLISHED", "blind_status": "NOT_BLIND", "independence_status": "NOT_INDEPENDENT"}, "claim_boundaries": spec["claim_boundaries"]}
