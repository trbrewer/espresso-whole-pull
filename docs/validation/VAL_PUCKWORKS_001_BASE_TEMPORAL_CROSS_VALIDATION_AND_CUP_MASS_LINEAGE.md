...
The VAL-CORPUS-002 source quantities are separately pinned to the approved
read-only evidence snapshot at Puckworks commit
`9c52c94edb27b461b6e7a4d471d29f3cef9d053e`, tree
`44d6539096648777f78c4db83f0985d5bd16e352`. In that snapshot,
`puckworks/data/schmieder2023/cup_masses.csv` has SHA-256
`39b7c16f9d9da614f151f46cb0db1440d43f150fbf49d3d2119f3f2fa1622f43`
and `puckworks/data/schmieder2023/kinetics_fit_params_avg.csv` has SHA-256
`00ff8c8344e9690274d2a6e7ec3f3d63b092d8b233d5f5f381301af09816b1d6`.
...
The five exact row identities are: experiment 2, replicate 3, caffeine,
brew ratio 1/1; experiment 4, replicate 1, caffeine, brew ratio 1/3;
experiment 14, replicate 2, 5-CQA, brew ratio 1/1; experiment 14, replicate
3, 5-CQA, brew ratio 1/3; and experiment 15, replicate 1, 5-CQA, brew ratio
1/3. The audit characterizes these only as duplicated/transcription-like
candidates; this local record makes no stronger source correction claim.
...
```bash
python3 -m unittest \
  tests.test_val_corpus_002_b2.StageB2ProspectiveTests.test_imported_base_cross_validation_identity_and_metrics \
  tests.test_val_corpus_002_b2.StageB2ProspectiveTests.test_every_governed_cup_mass_reference_carries_lineage
