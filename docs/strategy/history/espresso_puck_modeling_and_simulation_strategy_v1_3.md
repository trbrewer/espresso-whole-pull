...
**Date:** 27 July 2026
**Status:** Controlling strategy following successful WP-0.1F no-physics-change freeze finalization; WP-0.1H is complete and R0 is `FROZEN / QUALIFIED`; physical validation remains not established
**Supersedes:** `espresso_puck_modeling_and_simulation_strategy_v1_2.md` and all earlier strategy versions
