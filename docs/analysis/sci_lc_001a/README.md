# SCI-LC-001A protocol package

This directory is the human-readable entry point for the prospective
`SCI-LC-001A` reduced lateral equalization and channeling study. The controlling
authority is [PROTOCOL.md](PROTOCOL.md). Machine-readable authority and the
