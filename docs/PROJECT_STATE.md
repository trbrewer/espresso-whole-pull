...
- Active validation case: `VAL_CORPUS_002_STAGE_B0_FINAL_TOOLING_PENDING_REVIEW`
...
VAL-CORPUS-002 Stage A is exact-head approved. Stage B0 final prospective
tooling, including its content-verified governed P2 gate, is complete pending
review. OpenFOAM, calibration, governed scoring,
